...
public class Time {
    ...
    public Time subtract(Time otherTime) {
        ...
        if (this.hours >= otherTime.hours && this.mins >= otherTime.mins) {
            return new Time(this.hours - otherTime.hours, this.mins- otherTime.mins);
        } else if (this.hours >= otherTime.hours && this.mins < otherTime.mins) {
            return new Time(this.hours - otherTime.hours - 1, this.mins + 60 - otherTime.mins);
        } else if (this.hours < otherTime.hours && this.mins >= otherTime.mins) {
            return new Time(this.hours + 24 - otherTime.hours, this.mins - otherTime.mins);
        } else /*if (this.hours < otherTime.hours && this.mins < otherTime.mins)*/ {
            return new Time(this.hours + 23 - otherTime.hours, this.mins + 60 - otherTime.mins );
        }
    }
